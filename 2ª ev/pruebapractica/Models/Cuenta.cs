...
namespace Jose_Poveda_Practica4.Models
{
    public class Cuenta
    {
        ...
        public int Ingresar(int cantidad) // Funcion para ingresar dinero en la cuenta seleccionada
        {
            dinero += cantidad;
            return dinero;
        }
        public int Retirar(int cantidad) // Funcion para retirar dinero en la cuenta seleccionada
        {
            dinero -= cantidad;
            return dinero;
        }
